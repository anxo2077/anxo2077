...
```
Name     : Andres (anxo2077)
Role     : CS Student → Future SDE
Location : Idaho, US
Focus    : Full-stack dev, Android, Discord bots
...
### 🤖 Anxibed — Discord Logging Bot
> Production-grade Discord bot with slash commands, event logging, MongoDB persistence, and a file storage system via Nginx. Built with discord.js v14.

`JavaScript` `Node.js` `MongoDB` `Nginx` `discord.js`

---

### 🌐 Ankropix — Minecraft Hosting Site
> Multi-page website for a Minecraft server hosting brand. Dark theme, JavaScript gallery, form validation, and fully responsive layout.

`HTML` `CSS` `JavaScript`

---

### 📱 Android Coursework Apps
> A series of Android apps built with Kotlin & Jetpack Compose: API-driven fish facts, city info filters, Open Library browser, and more.

`Kotlin` `Jetpack Compose` `Retrofit` `REST APIs`
